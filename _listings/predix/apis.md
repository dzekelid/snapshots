...
created: "2018-08-28"
modified: "2018-08-28"
url: https://raw.githubusercontent.com/streamdata-gallery-topics/snapshots/master/_listings/predix/apis.md
...
- name: Asset - Get a snapshot of an entity at or before a specified datetime (ISO-8601).
  ...
  properties:
  - type: x-openapi-spec
    url: https://raw.githubusercontent.com/streamdata-gallery-topics/snapshots/master/_listings/predix/v1systemauditsnapshots-get-openapi.md
- name: Asset - Get a snapshot of an entity at or before a specified datetime (ISO-8601).
  x-api-slug: v1systemauditsnapshots-get
  description: For detailed documentation of all available query options please refer
    to Predix Asset Documentation.
