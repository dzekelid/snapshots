...
- name: Amazon ElastiCache API
  ...
  properties:
  - type: x-openapi-spec
    url: https://raw.githubusercontent.com/streamdata-gallery-topics/snapshots/master/_listings/aws-elasticache/action-describesnapshots-get.md
- name: Amazon ElastiCache API Create Snapshot
  ...
  properties:
  - type: x-openapi-spec
    url: https://raw.githubusercontent.com/streamdata-gallery-topics/snapshots/master/_listings/aws-elasticache/action-createsnapshot-get.md
x-common:
